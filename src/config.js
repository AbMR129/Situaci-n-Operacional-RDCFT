...
(function (RDCFT) {
  ...
  const REGIONAL_SPOTS = [
    ...
    { name: 'Chanco',       lat: -35.7344, lng: -72.5339, minZoom: 9 },
    { name: 'Pelluhue',     lat: -35.8261, lng: -72.6347, minZoom: 9 },
    ...
    { name: 'Cobquecura',   lat: -36.1314, lng: -72.7847, minZoom: 9 },
    { name: 'Trehuaco',     lat: -36.4303, lng: -72.6647, minZoom: 10 },
    { name: 'Coelemu',      lat: -36.4850, lng: -72.7011, minZoom: 10 },
    { name: 'Quirihue',     lat: -36.2817, lng: -72.5417, minZoom: 9 },
    ...
    { name: 'Yungay',       lat: -37.1194, lng: -72.0167, minZoom: 9 },
    { name: 'Pueblo Seco',  lat: -36.87998, lng: -72.09381, minZoom: 9 },
    ...
    { name: 'Nacimiento',   lat: -37.5000, lng: -72.6667, minZoom: 9 },
    ...
    { name: 'Angol',        lat: -37.8000, lng: -72.7167, minZoom: 9 },
    { name: 'Victoria',     lat: -38.2333, lng: -72.3333, minZoom: 9 },
    ...
    { name: 'Villarrica',   lat: -39.2856, lng: -72.2278, minZoom: 9 },
    ...
    { name: 'Panguipulli',  lat: -39.6333, lng: -72.3333, minZoom: 9 },
    ...
    { name: 'Futrono',      lat: -40.1333, lng: -72.4000, minZoom: 9 },
    ...
    { name: 'Ancud',        lat: -41.8697, lng: -73.8203, minZoom: 9 },
    { name: 'Puerto Varas', lat: -41.3195, lng: -72.9854, minZoom: 9 },
